...
public class Config {
    ...
    public static void newConfiguration() {
        ...
        ConfigManager.getConfiguration().addDefault("arenas.0.world", "world");
        ConfigManager.getConfiguration().addDefault("arenas.0.x", "16");
        ConfigManager.getConfiguration().addDefault("arenas.0.y", "69");
        ConfigManager.getConfiguration().addDefault("arenas.0.z", "32");
        ConfigManager.getConfiguration().addDefault("arenas.0.yaw", "0");
        ConfigManager.getConfiguration().addDefault("arenas.0.pitch", "90");
